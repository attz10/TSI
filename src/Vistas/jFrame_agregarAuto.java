 ...
 * @author atude
 */
public class jFrame_agregarAuto extends javax.swing.JFrame {

    /**
     * Creates new form jFrame_agregarAuto
     */
    public jFrame_agregarAuto() {
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(jFrame_agregarAuto.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new jFrame_agregarAuto().setVisible(true);
            }
        });
    }
